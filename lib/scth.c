...
* 	 the dynamic discovery of the position of the sys_call_table entries 
* 	 pointing to sys_ni_syscall - these entries are returned 
* 	 so that they can be exploited for rewriting sys_call_table and adding 
* 	 new system calls to Linux
*
